...
<link href="/themes/Local/css/417-landing-resources.css" rel="stylesheet" type="text/css" />
...
{include file="top-417-2013.tpl"}
	<div id="page-body">
			<div id="home-splash" style="padding-bottom:5px;">{loadModules position="top"}</div>	
	 	<div id="column-1">				
