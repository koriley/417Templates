...
<img class="tott-header-logo" alt="Top of the Town logo" src="/images/SpringfieldBest_LOGO.png" />
	<a href="/Springfields-Best"><img alt="Springfield's Best" class="new-header" src="/images/417SpringfieldBest_HEADERnew.png" /></a></div>
<div style="clear:both"></div>
	 	
<div id="columns-fullwidth" class=" tott-fw clearfix">
