...
<div class="essential-information">
			...
			{/if}
			{if $ops_geobasedata.email <>''}
			<div class="essential-item">
				<span class="eit">Contact Email: </span><span class="ei">{mailto address=$ops_geobasedata.email}</span>
			</div>
			{/if}
			<div class="essential-item">
...
{* END ESSENTIALS *}
        ...
        <div class="columns">
            ...
            {if !empty($ops_geobasedata.params.vimeo)}
            <div class="cf_video">
            <h2>Video</h2>
             <div class="content">
                 <div class="flex-video">
                    <iframe src="http://player.vimeo.com/video/{$ops_geobasedata.params.vimeo}?html5=0&rel=0" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
                  </div>
              </div>
            </div>
            {/if}
            ...
            {if !empty($ops_geobasedata.params.youtube)}
            <div class="cf_video">
            <h2>Video</h2>
             <div class="content">
                 <div class="flex-video">
                    <iframe src="http://www.youtube.com/embed/{$ops_geobasedata.params.youtube}?html5=0&rel=0" frameborder="0" allowfullscreen></iframe>
                  </div>
              </div>
            </div>
             {/if}
            ...
            {if !empty($ops_geobasedata.params.othervideo)}
            <div class="cf_video">
            <h2>Video</h2>
             <div class="content">
                    {$ops_geobasedata.params.othervideo}
              </div>
            </div>
            {/if}
            ...
            <h2>Review</h2>
             ...
             {/if}
              ...
              {if !empty($ops_geobasedata.params.specialevents)}
            <div class="description-wrapper">
             <h2>Special Events</h2>
             <div class="content">
               {$ops_geobasedata.params.specialevents}
             </div>
             </div>
             {/if}
            ...
            <div class="column-2">
			  {if $ops_geobasedata.params.showmap!="No"}
                ...
                <div class="tott-offers">
                    ...
                    <h2>Mobile Offers</h2>
                        <div class="content">
                        <p>Sign up for great offers from {$ops_geobasedata.company} by texting <strong>{$ops_geobasedata.params.ppm}</strong> to 90947.</p>
                        ...
                        <p class="fineprint">Note: Messaging and data rates apply. You can opt-out or terminate the mobile coupon service at anytime, by texting <strong>STOP to 90947</strong>. For help, text <strong>HELP to 90947</strong>.</p><p class="fineprint">When you click the Submit button below we will send a text message to your phone. To confirm that you received the message and that you will receive coupons, text YES to 90947.</p>
                        </p>
                        <div class="form-row last"><input type="checkbox" name="terms[]" value="accept" />I accept the <a target="_blank" href="/Springfields-Best/Terms-and-Conditions/">terms and conditions</a>.</div>
