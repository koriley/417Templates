...
<script type="text/javascript">
		new ClientsCDE('tott_geobase',{strip}[{section name="slides" loop=$listings max=$geobase.params.maxlistingsperpage|default:12}
