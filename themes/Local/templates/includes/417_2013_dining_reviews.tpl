{getarticles tagid=$tagID  what="article" order="ops_article.displayorder asc,ops_article.datepublished desc" }	
...
{if isset($articles)}	
	...
	{section name="t" loop=$articles max=$fmax}
		...
		{if $tagID == "41"}
	<div class="whitebox">
		<div style="width:100%; height:4px; margin-bottom:14px; padding-bottom:20px; margin-top:10px; background-color:#000; margin-right:5px;"><a href="http://www.417mag.com/417-Magazine/Department-Archive/index.php?tagID=15"><img style="margin-left:-17px;" alt="reviews" src="#" /></a></div>
			...
			<td valign="top" colspan="6">
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr class="department-header2">
						...
						<a href="http://www.417mag.com/417-Magazine/Department-Archive/index.php?tagID=15"  style="color:#D71921;  font-size:10pt;">Read More</a>
						</td>
