...
{if isset($articles)}	
		...
		{if $tagID == "179"}
	<div class="whitebox">
		<div style="width:100%; height:5px; margin-bottom:14px; padding-bottom:20px; margin-top:10px; background-color:#000; margin-right:5px;"><a href="http://www.417mag.com/417-Magazine/Department-Archive/index.php?tagID=179"><img style="margin-left:-17px;" alt="Recipies" src="http://www.417mag.com/images/elements/headers/wraps/recipes.png" /></a></div>
		...
		{section name="t" loop=$articles max='2'}
			...
			<td valign="top" colspan="2">
				<table border="0" cellspacing="0" cellpadding="0" width="300px" style="width:300px;" >
                                    <tr>
                                        <td>
                                            {if $articles[t].image<>''}<a href="{$articles[t].url}"><img src="{if $articles[t].image<>''}/core/includes/phpThumb/phpThumb.php?src={$articles[t].url}{$articles[t].image}&w=250&q=100{else}/images/blank.gif{/if}" border="0" width="250px" {if $articles[t].image<>''}{else}  {/if}alt="{$articles[t].title}" class="article-list-image" style="height:200px;" /></a>{else}&nbsp;{/if}
                                        </td>
                                    </tr>
			...
			<td valign="top" colspan="6">
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr class="department-header2">
						...
						<a href="http://www.417mag.com/417-Magazine/Department-Archive/index.php?tagID=179"  style="color:#D71921;  font-size:10pt;">Read More</a>
						</td>
