{getarticles tagids=$tagID what="article" max=$maxarticles order="ops_article.datepublished desc"}				
...
{if isset($articles)}		
	...
	<table class="articles" id="departments">
		...
		<a href="http://www.417mag.com/417-Magazine/Department-Archive/index.php?tagID={$tagID}">Read More</a>
		</div>
	  </div>	
