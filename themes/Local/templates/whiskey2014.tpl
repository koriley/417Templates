...
<meta property="og:image" content="http://www.417mag.com/images/whisky/2014/WhiskeyFest14_button.jpg" />
...
<body>
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse navBar">
    <ul class="nav navbar-nav pull-left">
      ...
      <ul class="nav navbar-nav navbar-right">
          ...
          <li ><div class="tweet popup" link="http://twitter.com/share" style="margin-top:10px; margin-right:-5px;"></div></li>
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse navBar" >
    ...
    <ul class="nav navbar-nav pull-left">
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		{*loadModules position="middle"*}
            ...
            <div class="footer">©2013 <i>417 Magazine’s</i> Whiskey Fest | Please Enjoy Responsibly.</div>
              {literal}
            ...
            $('.tweet').html('<a href="http://twitter.com/share"><img src="/images/whisky/2014/WhiskeyFest14_twitter.png" class="img-responsive"></a>');
    ...
    if(url === "fb"){ url = 'https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.417mag.com'+myUrl+'?v=1';
