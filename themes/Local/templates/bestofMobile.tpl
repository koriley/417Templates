...
echo "<meta http-equiv='refresh' content=\"0;URL='/417-Magazine/Best-Of-2014/Thank-You-Mobile/'\" />";
$this->assign('voted', TRUE);
}
...
{/php}
{if $voted eq TRUE}
    <meta http-equiv="refresh" content="0;URL='/417-Magazine/Best-Of-2014/Thank-You-Mobile/'"> 
{/if}
...
<link href="/themes/Local/css/bestOfMobile.css" rel="stylesheet" type="text/css" />
<meta name="viewport" content="width=device-width,user-scalable=no" />

{include file="jqueryLatest.tpl"}
</head>
<body>
    <div class="header"><a href="http://www.417mag.com/bestof/"><img src="/images/bestof/2014/BestOf417_microsite_header.png" /></a></div><br/>
