...
<link href="/themes/Local/css/417-ideahome.css" rel="stylesheet" type="text/css" />
...
<link rel="stylesheet" type="text/css" href="/themes/Local/css/galleries.css"  />
...
function IdeaHomeVideo(){

    // open a welcome message as soon as the window loads
    Shadowbox.open({
        content:    "http://www.youtube.com/v/NNmB8gVCJPw&hl=en&fs=1&rel=0&autoplay=1",
...
{include file="top-ideahome.tpl"}
	<div id="page-body">
	 	<div id="columns-1-2">
			...
			<table cellspacing="0" cellpadding="0" class="container-table" style="width:675px;">
				<tr>
					<td class="tlc"></td>
					<td class="top"></td>
					<td class="trc"></td>
					...
					<td>
						...
						<table cellpadding="0" cellspacing="0">
							<tr>
								...
								<td><a href="http://www.nixalawnservice.com/" onMouseOver="document.MyImage18.src='/images/ideahome/sponsors/sponsor_18roll.jpg';" onMouseOut="document.MyImage18.src='/images/ideahome/sponsors/sponsor_18.jpg';">
								<img src="/images/ideahome/sponsors/sponsor_18.jpg" name="MyImage18"></a></td>
								<td><a href="#" onMouseOver="document.MyImage19.src='/images/ideahome/sponsors/sponsor_19roll.jpg';" onMouseOut="document.MyImage19.src='/images/ideahome/sponsors/sponsor_19.jpg';">
								<img src="/images/ideahome/sponsors/sponsor_19.jpg" name="MyImage19"></a></td>
								<td><a href="http://www.fritzdc.com/Home.html" onMouseOver="document.MyImage20.src='/images/ideahome/sponsors/sponsor_20roll.jpg';" onMouseOut="document.MyImage20.src='/images/ideahome/sponsors/sponsor_20.jpg';">
								<img src="/images/ideahome/sponsors/sponsor_20.jpg" name="MyImage20"></a></td>
							</tr>
