...
<meta property="og:image" content="http://www.417mag.com/images/restaurantMonth/2012/RestaurantMonth_Island.jpg"/>
...
<link rel="stylesheet" type="text/css" href="/themes/Local/js/shadowbox.css">
            ...
            {literal}
                ...
                function harem20u30(){
                    ...
                    Shadowbox.open({
                        content:    "<div><a href='http://badads.com/openx/www/delivery/ck.php?n=ae7302fc&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://badads.com/openx/www/delivery/avw.php?campaignid=332&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=ae7302fc' border='0' alt='' /></a></div>",
                        player:     "html",
...
{include file="top-417-2010.tpl"}
	<div class="page-body">
		...
		<!-- <h1>{$Page->title}</h1> -->
                <div class="header"><img src="/images/boutiqueWeek/2012/WebCampaign_Before_landing.jpg" /></div>
                <div class="tabBar"><table><tr><td><a href="/417-Magazine/Boutique/"><div class="home"></div></a></td><td><a href="/417-Magazine/Boutique/EventsandSpecials/"><div class="events"></div></a></td><td><a href="http://www.417mag.com/417-Magazine/Boutique/BoutiqueMap/"><div class="map"></div></a></td><td><a href="/417-Magazine/Boutique/UltimateShoppingGiveaway/"><div class="giveaway"></div></a></td></tr></table></div>

  
	<div class=savinsPass" style="margin:auto; width:970px;">{loadModules position="middle"}	</div>
</div>		 
...
if(($email != "")&& ($email !="EMAIL ADDRESS") && ($savePass == "1")){
