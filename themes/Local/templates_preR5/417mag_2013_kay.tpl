{tagged tagid=$BlogtagID what="article" order="ops_article.displayorder asc,ops_article.datepublished desc"}
...
{if $taglist[t].articles[a].datepublished|date_format:"%B %e" == $smarty.now|date_format:"%B %e" }
        <td><div ><img src="/images/re/new-today.jpg"/></div></td>{/if}
					...
					<tr class="article-item">
						...
						<!--<p>{$taglist[t].articles[a].datepublished}</p>-->
                                                </td>
					</tr>
				</table>
			</td>										
...
{tagged tagid=$tagID what="article" issueid=$publication.issue.id max=5 order="ops_article.displayorder asc,ops_article.datepublished desc"}
