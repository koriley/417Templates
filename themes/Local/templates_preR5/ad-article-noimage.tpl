...
<div style="" id="header"><img src="http://www.417mag.com/images/mobile/417-Magazine2.png" /><div id="menuButton">Menu</div>
     </div>   <div id="dropMenu" style="visibility:hidden;">           
         
                      <a href="/417-Magazine/mobile-dining/"><div class="navItem">EAT</div></a>
                      <a href="/417-Magazine/mobile-shopping/"><div class="navItem">SHOP</div></a>
                      <a href="/417-Magazine/mobile-calendar/"><div class="navItem">DO</div></a>
                      <a href="http://www.417mag.com/417-Magazine/mobile-peoplePics/"><div class="navItem">PEOPLE PICS</div></a>
                      <a href="/417-Magazine/mobile-events/"><div class="navItem">BLOGS</div></a>
                    </div>
    <div class="middle">
