...
<form method="post" name="gallery" class="photoFader">
			...
			{counter start='0' name='number' print=false}
				...
				<div class="photoFader-contentcontainer">
					...
					<div id="item{counter name='image'}" class="photo"><a href="{$imagelist[images].linkurl}"><img src="/core/includes/phpThumb/phpThumb.php?src={$gallery.url}{$imagelist[images].image}&amp;w=750&amp;h=250&amp;q=75" alt="{$imagelist[images].description|escape:'htmlall'}" /></a></div>
					{/section}
				</div>
			</div>
</form>