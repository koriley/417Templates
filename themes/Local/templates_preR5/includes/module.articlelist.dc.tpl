...
<div class="tott ds tott-listings">   
    <h2>Designer Chat<a href="/Blogs/Designer-Chat/"><img src="/images/ds-logo.png" alt="Designer Chat Blog" /></a></h2>
    	<div class="content">
...
<a class="archive" href="/Blogs/Designer Chat/">Archive &raquo;</a>{/if}
</div></div>