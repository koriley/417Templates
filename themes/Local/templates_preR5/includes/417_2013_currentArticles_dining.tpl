{getarticles tagids=$tagID what="article" max='2' order="ops_article.displayorder asc,ops_article.datepublished desc" issueid=$publication.issue.id}				
...
{if isset($articles)}	
		...
		{if $tagID == "40"}
	<div class="whitebox">
		<div style="width:100%; margin-bottom:14px; height:4px; border-bottom:1px solid #919191; padding-bottom:20px; margin-top:10px; background-color:#000; margin-right:5px;"><a href="/417-Magazine/417-Dining/"><img alt="Dining" style="margin-left:-17px;" src="/images/elements/headers/wraps/dining-wrap.gif" /></a></div>
			...
			<td valign="top" colspan="6">
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr class="department-header2">
						...
						<a href="/417-Magazine/417-Dining/" style="color:#D71921;  font-size:10pt;">Read More</a>
						</td>
