...
<div id="customdata-details">
	<table id="customdata-tab" cellpadding="0" cellspacing="0">
		<tr>
	...
	<div class="listing-info">
			<table border="0" width="100%" id="customdata-details-table" cellspacing="0" cellpadding="0">
			...
			<tr><td colspan="2" class="rule"><img src="{$images}/blank.gif" alt="" width="1" height="1" /></td></tr> -->
           		 ...
           		 <tr><td valign="top" class="data-title" width="100"><b>Category:</b></td><td class="data">{$data.additionalinfo}</td></tr>
			<tr><td colspan="2" class="rule"><img src="{$images}/blank.gif" alt="" width="1" height="1" /></td></tr>
