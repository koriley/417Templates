...
{if isset($articles)}	
	...
	{section name="t" loop=$articles max=$fmax}
		...
		{if $tagID == "273"}
	<div class="whitebox">
		<div style="width:100%; height:5px; border-bottom:1px solid #919191; margin-bottom:14px; padding-bottom:20px; margin-top:10px; background-color:#000; margin-right:5px;"><a href="{$issue.url}"><img style="margin-left:-17px;" src="/images/elements/headers/wraps/in-this-issue.gif" /></a></div>
