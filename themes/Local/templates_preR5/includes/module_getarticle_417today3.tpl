...
{if isset($articles)}		
	  <div class="whitebox" style="width:300px;">
				
	<div class="blogContent">

	<table class="blog-articles" id="departments" style="width:100%;">
		{section name="a" loop=$articles max="5"}				
...
{/section}
					...
					<tr class="department-header">
						...
						<p class="article-byline"> {$blogcat} - {$articles[a].datepublished|dateformat:"%A, %B %e, %Y"} {if $articles[a].datepublished|date_format:"%B %e" == $smarty.now|date_format:"%B %e" }<img src="/images/re/new-today.png" width="60px">{/if} </p>                                    
						</td>
