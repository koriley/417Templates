...
<link href="/css/bvm-article.css" rel="stylesheet" type="text/css" />
...
<!-- stop leaderboard -->
	...
	<div id="page-body">
		...
		{section name=crumb loop=$breadcrumbs} {strip} {if $smarty.section.crumb.last} {$breadcrumbs[crumb].title} {else} <a href="{$breadcrumbs[crumb].url}" class="breadcrumblink">{$breadcrumbs[crumb].title}</a>&nbsp;/&nbsp;{/if} {/strip} {/section}
              ...
              <div id="leaderboard">
              <iframe id='a36fbdd2' name='a36fbdd2' src='http://badads.com/openx/www/delivery/afr.php?n=a36fbdd2&amp;zoneid=21&amp;cb=INSERT_RANDOM_NUMBER_HERE' framespacing='0' frameborder='no' scrolling='no' width='728' height='90'><a href='http://badads.com/openx/www/delivery/ck.php?n=a296b16b&amp;cb=INSERT_RANDOM_NUMBER_HERE' target='_blank'><img src='http://badads.com/openx/www/delivery/avw.php?zoneid=21&amp;cb=INSERT_RANDOM_NUMBER_HERE&amp;n=a296b16b' border='0' alt='' /></a></iframe>
