...
(function(f){
    ...
    updateCarouselSize:function(b){
        ...
        if(this.settings.scrollToLast){
            ...
            if(this._j1){
                ...
                if(0<a)for(a=this.numItems-a;a<this.numItems;a++)c+=this.items[a].width;else c=this.carouselWidth
    ...
    animateTo:function(b,
        ...
        this._e2();
        var h=this,n=this.settings.scrollbar,l=h._b1,j=h._c1,m=h._d1,q={
...
_d2:function(b){
    b=-b;
    for(var c,a=0;a<this.numItems;a++)if(c=this.items[a],b>=c.posX&&b<c.posX+c.width)return c;return-1
    },
_a2:function(){
...
_w1:function(b){
    if(!this._k2){
        ...
        var c;
        if(this.hasTouch)if(this._a=!1,(c=b.originalEvent.touches)&&0<c.length)c=c[0];else return!1;else c=b,b.preventDefault();
        this._l2();
        this._k2=!0;
        var a=this;
        this._w&&a._l.css({
