...
<div id="publication-container" class="page-container container-fluid">
	...
	{/if}
        ...
        <div class="row-fluid" id="LeftandRight">
                ...
                <div class="column-right respond-container span8 hidden-phone" id="" style="margin-top:-10px;">
		...
		<MESSAGES>
                ...
                <div class="column-left respond-container span12" id="">
                	{assign var="respond_containers" value="12,12"}
                        <div style="width:100%; height:25px; background-color:#6D6E71;"></div>
...
<script>
    ...
    /*jQuery(function(){
        ...
        var myUrl = window.location.pathname;
            ...
            jQuery('.fbShareChild').html('<a target="_blank" href="http://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.417mag.com'+myUrl+'%23.UTpMJRuqbfc.facebook"><img alt="" src="/images/spa/2015/Spa&SalonWeek_FacebookIcon_2015.png" /></a>');

        jQuery('.tweetChild').html('<a href="https://twitter.com/intent/tweet?button_hashtag=417cutestbaby" class="twitter-hashtag-button"><img alt="" src="/images/spa/2015/Spa&SalonWeek_TwitterIcon_2015.png" /></a>');
