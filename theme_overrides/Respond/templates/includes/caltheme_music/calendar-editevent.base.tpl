...
<form method="post" onsubmit="return autocheckByBlur(this);" enctype="multipart/form-data"  id="event" name="event" class="form-horizontal" >
	...
	{include file="caltheme_music/calendar-editeventdates.base.tpl"}
	...
	{if $calendar.customfields|@count}
		{include file="caltheme_music/edit_custom_fields.tpl" customfields=$calendar.customfields basetablename='ops_calendarevent'}
	{/if}
    ...
    <script>
            ...
            jQuery('.eventForm').appendTo('#calendarPlace');
