...
{/if*}-->
    ...
    <div class="input-append" name="search">
                               ...
                               <!-- <input class="add-on" type="submit" id="formbutton" value="Search" name="submit" style="height:auto;" />-->
                                 <button type="submit" class="btn add-on" name="submit" value="Search" id="formbutton" style="height:auto;">{$calendar_filters_action}</button>
                            </div>
