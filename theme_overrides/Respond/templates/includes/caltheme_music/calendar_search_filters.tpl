...
<form class="calendar-search-filters-form" name="event" method="get" action="/417-Live-Music-Calendar/">
   <!-- <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls"><div class="input-append date datepicker" id="dp2" data-date="{$startdate|dateformat:'%Y-%m-%d'}" data-date-format="yyyy-mm-dd">
            <input class="input-medium" size="16" type="text" name="enddate" value="{$startdate|dateformat:'%Y-%m-%d'}"><span class="add-on"><i class="icon-th"></i></span>
        </div></div>
    </div>
...
jQuery('input[name="enddate"]').val(newdate);
