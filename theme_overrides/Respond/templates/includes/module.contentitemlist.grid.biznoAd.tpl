...
{if defined("IS_AJAX")}
    ...
    {elseif $contentlist_count > 0}
        ...
        <div class="content-item-list noAd grid module {$module.class} content-closed" id="{$module.htmlid}">
        ...
        <script type="text/javascript">
            ...
            if (screenWidth >= 800) {ldelim}
                    jQuery(".noAd .articles .article-item:nth-child(7n+1)").addClass("bigStory");
                    jQuery(".noAd .articles .article-item").not(":nth-child(7n+1)").addClass("smallStory");
            ...
            {/strip}
                       ...
                       rjQuery('.noAd .article-item .article-content .article-tags .article-tag').each(function(){ldelim}
            ...
            {literal}
                jQuery(window).load(function() {
                    jQuery('.noAd .article-item .article-content .article-tags .article-tag').each(function() {
                        jQuery(this).show();
                    });
                });
            {/literal}
