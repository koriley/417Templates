...
<!-- The category -->
<form method="post" action="http://www.417mag.com/Dining/Dining-Guide/">
...
{getgeobaseinfo geobaseid="6" field="category" assign="cats"}  {foreach from=$cats item=cat}
...
{getgeobaseinfo geobaseid="6" field="city" assign="cities"}  {foreach from=$cities item="city"}
