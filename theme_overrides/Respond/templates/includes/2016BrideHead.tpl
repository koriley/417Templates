...
<meta property="og:image" content="http://417bride.com{$Page->path}{if $pagedata.image <> '' }{$pagedata.image}{/if}" />
<meta property="og:image:width" content="400">
<meta property="og:image:height" content="250">
<meta property="og:type" content="city"/>
<meta property="og:url" content="http://417bride.com{$smarty.server.REQUEST_URI}"/>
...
{addcss file="2016Bride.css" order="500"} {* this is a css workaround, since less doesnt seem to work correctly *}
