...
<meta property="og:image" content="http://417homemag.com{$Page->path}{if $pagedata.image <> '' }{$pagedata.image}{/if}" />

<meta property="og:type" content="city"/>
<meta property="og:url" content="http://417homemag.com{$smarty.server.REQUEST_URI}"/>
<meta property="og:site_name" content="417 HOME Magazine"/>
...
{addcss file="2014HomeTop.css" order="500"} {* this is a css workaround, since less doesnt seem to work correctly *}
