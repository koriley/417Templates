...
<meta name="fbimage" property="og:image" content="http://www.417mag.com{$Page->pageobject->url}{if $pagedata.image <> '' }{$pagedata.image}{/if}" />

<meta property="og:type"   content="website" />
<meta property="og:url" content="http://www.417mag.com{$Page->pageobject->url}{*$smarty.server.REQUEST_URI*}"/>
...
src="https://www.facebook.com/tr?id=975655509182934&ev=PageView&noscript=1"
/></noscript>
