...
jQuery('input[type="submit"]').hover().css({'background-position':'0px'});
    ...
    jQuery('#mySubmit').css({'background-image': 'url("https://www.417mag.com/images/coverDog/2016/417CoverDog_SubmitVoteButton.png")','background-repeat':'no-repeat', 'cursor': 'pointer', 'width': '310px', 'height': '150px'});
...
//e.preventDefault();
        ...
        var url = 'http://417mag.mkt7054.com/CoverDog2016/coverDog2016';
    ...
    if (screenwidth<=700){
        jQuery('.headerColor').css({'height':'84px','margin-top':'-10px'}); 
    }
